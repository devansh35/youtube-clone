...
const rawVideoBucketName = "course-raw-videos";
const processedVideoBucketName = "course-processed-videos";
 ...
 * @returns A promise that resolves when  the videohas been converted.
 */
...
function deleteFile(filePath: string): Promise<void> {
    return new Promise((resolve, reject) => {
        if (fs.existsSync(filePath)) {
            ...
            console.log(`File not found at ${filePath}, skipping the deletion.`);
            resolve();
        }
    });
}
